...
typedef struct xnodo {
 ...
 void buscar(char * , xapuntador * , int * , xapuntador *, posicion *);
...
void grabarnodo(xapuntador *xp, struct xnodo *xpn, const int variableArray) {
    ...
    int tamanyoRegistro;     int posicion;  int i;
...
void leenodo(xapuntador *xp, struct xnodo *xpn,const int variableArray) {
...
void buscar(tipollave *objetivo, xapuntador *xraiz, int *encontrar,
...
int main2() {
    short int abierto = 0;      extern int depurar;
